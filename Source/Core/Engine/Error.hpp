...
DK_ENUM_CLASS(EError, U8, NO_ERR, FILE_NOT_FOUND, DIRECTORY_ALREADY_EXIST, ACCESS_DENIED,
	DIRECTORY_NOT_CREATED, DIRECTORY_NOT_FOUND, CLASS_NOT_FOUND, FILE_NOT_OPENED, JOINT_NOT_FOUND)

#define DK_OK core::EError::NO_ERR
#define DK_DIR_OK(x) x == DK_OK || x == core::EError::DIRECTORY_ALREADY_EXIST

#define DK_MATH_ERROR0(x) "Template type '"DK_STRINGIZE(x)"', must be a Scalar Type( eg : I/U 8-16-32, F32 ) and not a 64 bit Scalar Type( eg : I/U 64, F64 ) !!"
