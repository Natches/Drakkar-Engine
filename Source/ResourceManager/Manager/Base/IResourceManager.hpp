...
protected:
	...
	virtual void preload(const definition::ResourceName& rNames, const std::string& filename) = 0;
	virtual void preload(const std::string& name, const std::string& filename) = 0;
