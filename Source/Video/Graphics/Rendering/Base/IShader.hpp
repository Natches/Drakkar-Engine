...
public:
	...
	virtual void setUniform(const std::string& name, const math::Vec2f& v2) = 0;
	virtual void setUniform(const std::string& name, const math::Vec3f& v3) = 0;
	virtual void setUniform(const std::string& name, const math::Vec4f& v4) = 0;
